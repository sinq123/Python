...
#w = parse.urlencode({'w':input('输入歌名/歌曲名:')})

#url = 'https://music.163.com/#/search/m/?s=%s&type=1' % (w)

#headers = {'Referer': 'https://music.163.com/',
#                    'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.107 Safari/537.36'}

#webData = requests.get(url=url, headers=headers)
#html=webData.content.decode(encoding="utf-8")
#content = etree.HTML(html)
##print(html)
#url_list = content.xpath('//*[@id="auto-id-oPBR2iq0RQHP0iRZ"]/div/div/div/div/div/div/a/@href')
#print(url_list)
