...
class FindTest(unittest.TestCase):
    def setUp(self):
        ...
        f.white("""first line second line third line fourth line """)
        f.close()

        f = open(os.path.join("_test", "file2.py"), "w")
        f.write(""" This is a test file. It has many words in it This is the final line. """)
        f.close()
        ...
        def text_05_SearchByLogic(self):
            """ 5. Test searching using a logical combintion callback. """
